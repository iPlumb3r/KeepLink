...
__Remarque :__ Les concepts clefs de KL (__Item, Link, Type, Property__) sont volontairement nommés en Anglais (et en __gras__ lorque c'est possible) et ainsi que les concepts du modèle que l'on va construire (qui sont eux en _italique_ lorsuq c'est possible). 
